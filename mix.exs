defmodule TableauEexExtension.MixProject do
  use Mix.Project

  @app :tableau_eex_extension
  @project_url "https://github.com/halostatue/tableau_eex_extension"
  @version "1.0.0"

  def project do
    [
      app: @app,
      description: "TableauEexExtension processes eex files in a Tableau context.",
      version: @version,
      source_url: @project_url,
      name: "TableauEexExtension",
      elixir: "~> 1.18",
